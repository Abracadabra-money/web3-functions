export default [
	{
		...
		inputs: [{ type: "uint16", name: "_chainId", internalType: "uint16" }],
	},
	{
		type: "event",
	...
	},
	{
		...
		inputs: [
			...
			{ type: "uint64", name: "nonce", internalType: "uint64", indexed: false },
			{
				type: "address",
				name: "dstAddress",
				internalType: "address",
	...
	},
	{
		...
		inputs: [
			...
			{ type: "uint64", name: "nonce", internalType: "uint64", indexed: false },
			{ type: "bytes", name: "payload", internalType: "bytes", indexed: false },
			{ type: "bytes", name: "reason", internalType: "bytes", indexed: false },
		],
		anonymous: false,
	},
	{
	...
	},
	{
		...
		inputs: [
			{ type: "address", name: "ua", internalType: "address", indexed: false },
			{
				type: "uint16",
				name: "version",
				internalType: "uint16",
	...
	},
	{
		...
		inputs: [
			...
			{ type: "address", name: "_userApplication", internalType: "address" },
			{ type: "bytes", name: "_payload", internalType: "bytes" },
			{ type: "bool", name: "_payInZRO", internalType: "bool" },
	...
	},
	{
		...
		inputs: [
			{ type: "uint16", name: "_dstChainId", internalType: "uint16" },
			{ type: "address", name: "_srcAddress", internalType: "address" },
		],
	},
	{
		type: "function",
	...
	},
	{
		...
		stateMutability: "view",
		outputs: [
			{ type: "address", name: "sendLibraryAddress", internalType: "address" },
		],
	...
	},
	{
		...
		inputs: [
			{ type: "uint16", name: "_srcChainId", internalType: "uint16" },
			{ type: "bytes", name: "_srcAddress", internalType: "bytes" },
			{ type: "address", name: "_dstAddress", internalType: "address" },
	...
	},
	{
		...
		inputs: [
			{ type: "uint16", name: "_dstChainId", internalType: "uint16" },
			{ type: "bytes", name: "_destination", internalType: "bytes" },
			{ type: "bytes", name: "_payload", internalType: "bytes" },
			{
				type: "address",
				name: "_refundAddress",
	...
	},
	{
		...
		inputs: [{ type: "uint16", name: "_newVersion", internalType: "uint16" }],
	},
	{
		type: "function",
		stateMutability: "nonpayable",
	...
	},
	{
		...
		stateMutability: "view",
		outputs: [
			{ type: "uint64", name: "payloadLength", internalType: "uint64" },
			{ type: "address", name: "dstAddress", internalType: "address" },
			{ type: "bytes32", name: "payloadHash", internalType: "bytes32" },
		],
		name: "storedPayload",
		inputs: [
			{ type: "uint16", name: "", internalType: "uint16" },
	...
	},
	{
		...
		stateMutability: "view",
		outputs: [
			{ type: "uint16", name: "sendVersion", internalType: "uint16" },
			{ type: "uint16", name: "receiveVersion", internalType: "uint16" },
			{
				type: "address",
				name: "receiveLibraryAddress",
				internalType: "address",
