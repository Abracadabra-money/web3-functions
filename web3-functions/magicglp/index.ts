...
Web3Function.onRun(async (context: Web3FunctionContext) => {
  ...
  const rewardTokenChainlinkAddress = userArgs.rewardTokenChainlinkAddress as string;
  ...
  if (rewardTokenAmount.gt(0)) {
    ...
    try {
      ...
      console.log("projected glp mint amount", mintGlpAmount.toString() as unknown as number / 1e18);
    } catch (err: any) {
    ...
    SimulationUrlBuilder.log([GELATO_PROXY[gelatoArgs.chainId]], [execAddress], [0], [callData.data], [gelatoArgs.chainId]);
