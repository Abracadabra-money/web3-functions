...
import { type Address, encodeFunctionData, parseAbi, type PublicClient } from 'viem';
...
Web3Function.onRun(async ({ userArgs, multiChainProvider }: Web3FunctionContext) => {
  const { multiRewardDistributorAddress, multiRewardStakingAddresses, epochBasedDistributorAddress, epochBasedStakingAddresses } = userArgs as RewardDistributorUserArgs;
